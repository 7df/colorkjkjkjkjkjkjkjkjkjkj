...
//مثال تكرر الكود مع الالوان 



client.on('message', message => {
  if (message.content.startsWith('لون 4')) {
     if(!message.channel.guild) return;
  message.member.addRole(message.guild.roles.find("name", "4"));
...
client.on('message', msg => {
  if (msg.content === 'لون 4') {
    msg.reply('تم اعطاءك الوان الرابع');
  }
});
...
client.on('message', message => {
  if (message.content.startsWith('لون 1')) {
     if(!message.channel.guild) return;
  message.member.addRole(message.guild.roles.find("name", "1"));
...
client.on('message', msg => {
  if (msg.content === 'لون 1') {
    msg.reply('تم اعطاءك الون');
  }
});
